...
/**
 * MaterialLayout是模拟Android 5.0中View被点击的波纹效果的布局，所有在MaterialLayout布局下的子视图被点击时都会产生波纹效果
 *
...
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_ml_color, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout_ml_duration,
                                          DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.MaterialLayout_ml_frame_rate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_ml_alpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.MaterialLayout_ml_scale, DEFAULT_SCALE);
